        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoldInvoiceId = table.Column<long>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Devices_Invoices_SoldInvoiceId",
                        column: x => x.SoldInvoiceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaintenancePlans_Devices_DeviceId",
                        column: x => x.DeviceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceSchedules_MaintenancePlans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkType = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Notes = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    WarrantyCovered = table.Column<bool>(type: "INTEGER", nullable: false),
                    CostAmount = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceVisits_MaintenanceSchedules_ScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_SoldInvoiceId",
                table: "Devices",
                column: "SoldInvoiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenancePlans_DeviceId",
                table: "MaintenancePlans",
                column: "DeviceId");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceSchedules_DueDate",
                table: "MaintenanceSchedules",
                column: "DueDate");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceSchedules_PlanId",
                table: "MaintenanceSchedules",
                column: "PlanId");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceVisits_ScheduleId",
